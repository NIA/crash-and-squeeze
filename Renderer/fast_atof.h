...
// ------------------------------------------------------------------------------------
// This header was taken from https://github.com/assimp/assimp
...
inline const char* fast_atoreal_move( const char* c, Real& out, bool check_comma = true)
{
	...
	if ((c[0] == 'N' || c[0] == 'n') && _strnicmp(c, "nan", 3) == 0)
	{
	...
	if ((c[0] == 'I' || c[0] == 'i') && _strnicmp(c, "inf", 3) == 0)
	{
		...
		c += 3;
		if ((c[0] == 'I' || c[0] == 'i') && _strnicmp(c, "inity", 5) == 0)
		{
			c += 5;
		}
		return c;
