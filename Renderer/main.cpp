...
INT WINAPI wWinMain( HINSTANCE, HINSTANCE, LPWSTR, INT )
{
    ...
    try
    {
        ...
        VertexShader skinning_shader(app.get_device(), SKINNING_VERTEX_DECL_ARRAY, SIMPLE_SHADER_FILENAME);
        VertexShader morphing_shader(app.get_device(), VERTEX_DECL_ARRAY, SIMPLE_SHADER_FILENAME);
